    ...
    switch (peripheral.state) {
        ...
        case 5:
        {
            ...
            self.customCharacteristic = [[CBMutableCharacteristic alloc] initWithType:
                                         characteristicUUID properties:CBCharacteristicPropertyNotify|CBCharacteristicPropertyRead|CBCharacteristicPropertyWrite value:nil permissions:CBAttributePermissionsReadable|CBAttributePermissionsWriteable];
...
- (void)peripheralManager:(CBPeripheralManager *)peripheral didReceiveWriteRequests:(NSArray<CBATTRequest *> *)requests{
    ...
    NSString * string = [[NSString alloc]initWithData:aTTRequest.value encoding:NSUTF8StringEncoding];
    self.showLable.text = string;
